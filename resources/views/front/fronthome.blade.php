        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="imgs-grid">
                        <div class="grid grid-1"><img src="{{ asset('front') }}/images/img-grid-1.jpg" alt="Untree.co">
                        </div>
                        <div class="grid grid-2"><img src="{{ asset('front') }}/images/img-grid-2.jpg" alt="Untree.co">
                        </div>
                        <div class="grid grid-3"><img src="{{ asset('front') }}/images/img-grid-3.jpg" alt="Untree.co">
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="testimonial-block text-center">
                                            ...
                                            <div class="author-info">
                                                <div class="author-pic">
                                                    <img src="{{ asset('front') }}/images/person-1.png" alt="Maria Jones"
                                                        class="img-fluid">
                                                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img src="{{ asset('front') }}/images/post-1.jpg"
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img src="{{ asset('front') }}/images/post-2.jpg"
                                alt="Image" class="img-fluid"></a>
                        <div class="post-content-entry">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img src="{{ asset('front') }}/images/post-3.jpg"
                                alt="Image" class="img-fluid"></a>
                        <div class="post-content-entry">
