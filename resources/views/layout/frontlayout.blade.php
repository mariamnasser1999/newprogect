        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsFurni">
                <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <li class="@yield('about-active')"><a class="nav-link" href="{{ Route('theme.about') }}">About us</a>
                    </li>
                    <li class="@yield('services-active')"><a class="nav-link" href="{{ Route('services') }}">Services</a></li>
                    <li><a class="nav-link" href="blog.html">Blog</a></li>
                    <li class=" @yield('contact-active')"><a class="nav-link" href="{{ Route('theme.contact') }}">Contact
                            us</a></li>
                </ul>
